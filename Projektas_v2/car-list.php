								...
								<form class="order-details" action="car-list.php" method="post">
									<div class="included-extras-and-driver-form">
										<div class="included-and-extras">
											...
											<div class="extras">
												...
												<span><input id="full-kasko" type="checkbox" name="full_kasko" value="pilnas-Kasko" onchange="uncheckKasko();">Pilnas Kasko draudimas(10€/para)</span><br>
												<span><input id="unlimited-mileage" type="checkbox" name="unlimited_mileage" value="neribota-rida" onchange="uncheckMileage();">Neribota rida (10€/para)</span><br>
												<span><input class="extra-driver" type="checkbox" name="extra_driver" value="papildomas-vairuotojas">Papildomas vairuotojas (5€/para)</span><br>
												<span><input class="wifi" type="checkbox" name="wifi" value="wi-fi">Wi-Fi (3€/para)</span><br>
												<span><input type="checkbox" name="child_seat" value="kėdutė">Vaikiška kėdutė (nemokamai)</span><br>
												<span><input type="checkbox" name="gps" value="gps">GPS (nemokamai)</span>
											</div>
											<hr>
										</div>
										<div class="driver-information">
											...
											<div class="form-row">
												<div class="driver-form">
													<label for="birthday">Gimimo data: <span>*</span></label><br>
													<input type="text" name="birthday" placeholder="Jūsų gimimo data">
												</div>
												<div class="driver-form">
													<label for="flight-number">Skrydžio numeris:</label><br>
													<input type="text" name="flight_number" placeholder="Skrydžio numeris">
												</div>
											</div>
											<div class="form-row">
												<div class="driver-form">
													<label for="message">Pageidavimai: </label><br>
													<textarea name="message" placeholder="Jūsų pageidavimai..."></textarea>
												</div>
											</div>
										</div>
									</div>
									<div class="total-price-and-payment">
										...
										<div class="payment-choice">
											...
											<span>
												<input id="paypal" type="radio" name="paypal" disabled>
												<label for="paypal">Paypal</label>
											</span>
											<span>
												<input id="credit-card" type="radio" name="credit-card" disabled>
												<label for="credit-card">Banko kortele</label>
											</span>
											<span>
												<input id="pay-later" type="radio" name="pay-later">
												<label for="pay-later">Mokėti atsiimant</label>
											</span>
										</div>
										<div class="button-continue">
											<div>
												<button id="continue-to-payment" class="button">Užsakyti</button>
											</div>
										</div>
									</div>
								</form>
								...
								<form class="order-details">
									<div class="included-extras-and-driver-form">
										...
										<div class="driver-information">
											...
											<div class="form-row">
												<div class="driver-form">
													<label for="car">Gimimo data: <span>*</span></label><br>
													<input type="text" name="interest_car" placeholder="Dominantis automobilis">
												</div>
												<div class="driver-form">
													<label for="period">Skrydžio numeris:</label><br>
									...
									<div class="total-price-and-payment">
										...
										<div class="button-continue">
											<div>
												<button id="continue-to-payment2" class="button">Užsakyti</button>
											</div>
										</div>
									</div>
								</form>
							...
							<div class="modal-content">
								...
								<form class="order-details">
									...
									<div class="total-price-and-payment">
										...
										<div class="button-continue">
											<div>
												<button id="continue-to-payment3" class="button">Užsakyti</button>
											</div>
										</div>
									</div>
								</form>
							...
							<div class="modal-content">
								...
								<form class="order-details">
									...
									<div class="total-price-and-payment">
										...
										<div class="button-continue">
											<div>
												<button id="continue-to-payment4" class="button">Užsakyti</button>
											</div>
										</div>
									</div>
								</form>
							...
							<div class="modal-content">
								...
								<form class="order-details">
									...
									<div class="total-price-and-payment">
										...
										<div class="button-continue">
											<div>
												<button id="continue-to-payment5" class="button">Užsakyti</button>
											</div>
										</div>
									</div>
								</form>
